    ...
    <div class="form-group">
        ...
        <div class="form-row">
            ...
            <div class=" col-md-3">
                ...
                <input type="text" id='nome' class="form-control" placeholder="Nome Completo" aria-describedby="validationServer03Feedback" required>
            ...
            <div class="col-md-2">
                ...
                <select class="custom-select" id="validationCustom04" required>
                    <option selected disabled value="">Solteiro</option>
                    <option>Viuvo</option>
                </select>
            </div>
