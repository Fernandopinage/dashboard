<legend class="legend">Cadastro de Parceiros </legend><hr><br><br>
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Dados Pessoais</a>
        <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Endereço</a>
        ...
        <a class="nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-dependente" role="tab" aria-controls="nav-dependente" aria-selected="false">Dependentes</a>
    </div>
</nav>
<form>
...
<div class="tab-content" id="nav-tabContent">
    ...
    <!-- DEPENDENTE -->
    <div class="tab-pane fade" id="nav-dependente" role="tabpanel" aria-labelledby="nav-dependente-tab">
        <div class="form-group card border" style="padding: 35px 35px 35px 35px; ">
